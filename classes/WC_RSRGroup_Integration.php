...
class WC_RSRGroup_Integration extends WC_Integration {
	...
	function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'offset_row' => array(
				'title' => __( 'Starting Row', 'woocommerce_rsrgroup' ),
				'description'   => __( 'Enter a row to offset importing, leave blank to begin at the first entry.', 'woocommerce_rsrgroup' ),
				'css'   => 'width:100px;',
				'type'   => 'number',
			...
			'remaining_rows' => array(
				'title' => __( 'Import Rows', 'woocommerce_rsrgroup' ),
				'description'   => __( 'Leave blank to retrieve all remaining rows after the starting row.', 'woocommerce_rsrgroup' ),
				'css'   => 'width:100px;',
				'type'   => 'number',
				'custom_attributes' => array(
					'min'  => 0,
